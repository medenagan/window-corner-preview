...
var WindowCornerIndicator = new Lang.Class({
    ...
    _onZoomChanged: function(source) {
        this.preview.zoom = source.value;
        this._updateSliders();
        this.preview.emit("zoom-changed");
    },

    _onLeftCropChanged: function(source) {
        this.preview.leftCrop = source.value;
        this._updateSliders();
        this.preview.emit("crop-changed");
    },

    _onRightCropChanged: function(source) {
        this.preview.rightCrop = source.value;
        this._updateSliders();
        this.preview.emit("crop-changed");
    },

    _onTopCropChanged: function(source) {
        this.preview.topCrop = source.value;
        this._updateSliders();
        this.preview.emit("crop-changed");
    },

    _onBottomCropChanged: function(source) {
        this.preview.bottomCrop = source.value;
        this._updateSliders();
        this.preview.emit("crop-changed");
    },
